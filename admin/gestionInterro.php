...
//Refaire copie
                    ...
                    if (isset($_POST['idInterro'])) {
                        ...
                        <table border=1>
                            ...
                            while ($ligne = mysqli_fetch_array($result)) {
                                ...
                                <tr><td>
                                        <?php
                                        echo $ligne["idEtudiant"] . "</td><td>" . $ligne["total"] . "</td>
			...
			<td>";
                        ...
                        <a href="#" onclick="if (confirm('Voulez-vous supprimer cette interro ?')) {
                                    document.location.href = 'gestionInterro.php?suppInterro=<?php echo $_POST['idInterro']; ?>';
                                }"><img width="80px;" src="../img/supp.png" alt="Supprimer interro"/></a>
                        <br/><br/>
                        <?php
                    }else {
                        ?>
