...
if (!isset($_POST['idClasse'])){
	...
	if ($num_rows>0){
	 ...
	 }else echo "Merci de creer vos classes avant";
	?>
	
	</select>
	<br/>
	<input type="submit" value="Voir les eleves de la classe"/>
	</form>
<br/><br/><br/>
	...
	<form method="POST" action="imprimerCodesEtudiant.php" name="myform">
		...
		<a href="#" onclick="if (confirm('Voulez-vous supprimer cette classe ?')) { document.myform.submit();}"><img width="80px;" src="../img/supp.png" alt="Supprimer classe"/></a>	
	</form>
<br/><br/>
	<form method="POST" action="imprimerCodesEtudiant.php">
